...
<ul class="nav nav-tabs">
    <li class="nav-item">
	<a class="nav-link" href="/mail/" target="_blank">Web почта</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
	<a class="nav-link"  href="https://192.168.41.2:10000/" target="_blank">Webmin</a>
    </li>
	<li class="nav-item">
	<a class="nav-link" href="/netdata/" target="_blank">NetData</a>
    </li>
    <li class="nav-item">
	<a class="nav-link" href="/iredadmin/" target="_blank">iRedAdmin панель</a>
    </li>
</ul>
<div>&nbsp;</div>
...
<caption>Список Алиасов &nbsp;ОАО "Моя Контора"</caption>
    <thead>
	<tr>
	    <th>#</th>
	    <th>Alias</th>
